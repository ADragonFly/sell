...
//        bestPayService.setWxPayH5Config(wechatPayConfig.bestPayService());
//        wechatPayConfig.bestPayService();
...
//        PayResponse response = wechatPayConfig.bestPayService().pay(payRequest);
